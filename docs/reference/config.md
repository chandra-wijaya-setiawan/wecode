...
already in the tree the worker lands in: it is committed at `.wecode/playbook.toml` in
the project's own repository, which is what makes it a description of that code rather

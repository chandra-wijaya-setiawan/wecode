...
What is in the box. No arrows: this says what the parts are, not who calls whom.
...
| row | components | what they are |
|---|---|---|
| surface | **engine · makers · edits** | the only things that change a row |
| model | **state machines · entities · guards** | what may exist, and what may happen to it |
| reads | **board · tree** | the two questions: what is happening, and what is the shape |
| record | **repository · ledger · store · migrations** | where it is written, and how the file gets its shape |
| files | **roles · stacks · home** | what wecode learns from config rather than code |

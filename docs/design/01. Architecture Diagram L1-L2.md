...
flowchart TB
    ...
    subgraph core["@wecode/core"]
        direction TB
        ENGINE["<b>engine</b><br/>the only thing that changes a row"]
        MODEL["<b>model</b><br/>what may exist, and what may happen to it"]
        LEDGER["<b>ledger</b><br/>every transition, appended, never updated"]
        STORE["<b>store</b><br/>the file, its shape, and every transaction"]
